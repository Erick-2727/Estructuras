...
public class TestBinario {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(ANSI_YELLOW_BACKGROUND + "----------------------------------------------------------------------------------------------------------"
                + "----------------------------------------------------------------------------------------" + RESET);
        System.out.println("\n\n**********************************");
        System.out.println("*      Test de Ancestros         *");
        System.out.println("**********************************\n");
        System.out.println("Inserto el 3 en raiz " + ((c.insertar(3, 1, 'I')) ? sOk : sErr));
        System.out.println("Inserto el 9 como hijo I de 3 " + ((c.insertar(9, 3, 'I')) ? sOk : sErr));
        System.out.println("Inserto el 7 como hijo I de 9 " + ((c.insertar(7, 9, 'I')) ? sOk : sErr));
        System.out.println("Inserto el 5 como hijo D de 9 " + ((c.insertar(5, 9, 'D')) ? sOk : sErr));
        System.out.println("Inserto el 15 como hijo D de 3 " + ((c.insertar(15, 3, 'D')) ? sOk : sErr));
        System.out.println("Inserto el 12 como hijo I de 15 " + ((c.insertar(12, 15, 'I')) ? sOk : sErr));
        System.out.println("Inserto el 20 como hijo D de 15 " + ((c.insertar(20, 15, 'D')) ? sOk : sErr));
        System.out.println("Inserto el 10 como hijo D de 5 " + ((c.insertar(10, 5, 'D')) ? sOk : sErr));
        System.out.println("Siendo el Arbol");
        System.out.println(c.toString());
        System.out.println("Ancestro de 10. Tiene que dar: [ 5 9 3 ] ---> " + c.ancestros(10).toString());
        System.out.println("Ancestro de la raiz 3. Tiene que dar: Lista Vacia ---> " + c.ancestros(3).toString());
        System.out.println("Ancestro de 20. Tiene que dar: [ 15 3 ] ---> " + c.ancestros(20).toString());
        System.out.println("Ancestro de 40 que no esta en el arbol. Tiene que dar: Lista Vacia ---> " + c.ancestros(40).toString());
        System.out.println("\n");
