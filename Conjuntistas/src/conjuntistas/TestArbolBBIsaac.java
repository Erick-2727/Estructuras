...
public class TestArbolBBIsaac {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < arr.length; j++) {
            System.out.println("El mínimo es " + arr[j] + ": " + comprobar(a.minimoElem().equals(arr[j])));
            System.out.println("Elimino el mínimo: " + comprobar(a.eliminarMin()));
        }
        System.out.println("El mínimo en árbol vacío: " + comprobar(a.minimoElem() == null));
        System.out.println("Elimino el mínimo en árbol vacío: " + comprobar(a.eliminarMin() == false));

        cartel("Test máximo");
        llenar(a, num);
        for (int k = arr.length - 1; k >= 0; k--) {
            System.out.println("El máximo es " + arr[k] + ": " + comprobar(a.maximoElem().equals(arr[k])));
            System.out.println("Elimino el máximo: " + comprobar(a.eliminarMax()));
        }
        System.out.println("El máximo en árbol vacío: " + comprobar(a.maximoElem() == null));
        System.out.println("Elimino el máximo en árbol vacío: " + comprobar(a.eliminarMax() == false));
