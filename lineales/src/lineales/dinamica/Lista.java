...
public class Lista {
	...
	/**
	 * Agrega el elemento pasado por parametro en la posicion pos,la
	 * cantidad de elementos de la lista se incrementa en 1. Para una insercion
	 * exitosa, la posicion recibida debe ser 1 <= pos<= longitud(lista) + 1.
	...
	/**
	 * Borra el elemento de la posicion pos, por lo que la cantidad de elementos de
	 * la lista disminuye en uno. Para una eliminacion exitosa, la lista no debe
	 * estar vacia y la posicion recibida debe ser 1 <= pos <= longitud(lista).
...
public int localizar(Object busc) {
	...
	/**
	 * Devuelve el elemento de la posicion pos. La precondicion es que la posicion
	 * sea valida.
        */
	 ...
	 * la lista para poder mostrarla por pantalla.
	 */
